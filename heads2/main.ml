(* Generated by ./config.exe configure -t unix (2020-01-20 15:39:04-00:00). *)
...
module Unikernel1 = Unikernel.Heads2(Console_unix)(OS.Time)
...
let key1 = lazy (
  ...
  return (Functoria_runtime.with_argv (List.map fst Key_gen.runtime_keys) "heads2" _argv_unix1)
  )
