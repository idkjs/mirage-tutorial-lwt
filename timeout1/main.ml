(* Generated by ./config.exe configure -t unix (2020-01-20 15:40:34-00:00). *)
...
module Unikernel1 = Unikernel.Timeout1(Console_unix)(OS.Time)
...
let key1 = lazy (
  ...
  return (Functoria_runtime.with_argv (List.map fst Key_gen.runtime_keys) "timeout1" _argv_unix1)
  )
